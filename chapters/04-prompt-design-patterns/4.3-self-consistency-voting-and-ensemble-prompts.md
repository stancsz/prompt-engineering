...
*   **Mechanism:**
    ...
    3.  **Aggregate by Majority Vote:** The final answer is determined by taking the majority vote among the extracted answers. If there's a tie, further strategies (e.g., picking the shortest, or prompting the model to resolve the tie) can be used.
